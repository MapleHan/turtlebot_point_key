...
max_linear_vel = 0.1 # 最大线速度
max_angular_vel = 0.3 # 最大角速度
min_linear_vel = 0.01 # 最小线速度
...
way_points = [
  dict(type ='move', x=1,   y=0.5,  a=0),
  dict(type ='move', x=0,   y=0.5,  a=-20),
  dict(type ='move', x=0.5, y=0.2,  a=112),
  dict(type ='move', x=0.7, y=1,    a=60),
  dict(type ='move', x=0,   y=0.5,  a=-25),
  #dict(type ='up'),
  dict(type ='move', x=-1,  y=0.5,  a=-70),
  dict(type ='move', x=-1,  y=0.5,  a=10),
